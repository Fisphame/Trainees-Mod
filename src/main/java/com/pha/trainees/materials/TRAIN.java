...
public class TRAIN{
    ...
    private static final Supplier<Ingredient> REPAIR_MATERIAL = () ->
            Ingredient.of(ForgeRegistries.ITEMS.getValue(
                    new ResourceLocation(Main.MODID, "two_half_ingot")
            ));//修复材料
    ...
    public static class I implements ArmorMaterial {
        ...
        public int getDurabilityForType(ArmorItem.Type type) {
            return DURABILITY_PER_SLOT[type.getSlot().getIndex()] * DURABILITY_PER_SLOT_COEFFICIENT[level]; // 铁甲级耐久
        }
        @Override
        public int getDefenseForType(ArmorItem.Type type) {
            return PROTECTION_PER_SLOT[level][type.getSlot().getIndex()];
        }
        @Override
        public int getEnchantmentValue() {
            return ENCHANTMENT_VALUE[level]; // 铁级附魔能力
        }
        @Override
        ...
        public String getName() {
            return "trainees:train_i"; // 纹理路径: train_i_layer_1.png
        }
        @Override
        public float getToughness() {
            return TOUGHNESS_VALUE[level]; // 无韧性
        }
        @Override
        public float getKnockbackResistance() {
            return KNOCKBACK_RESISTANCE_VALUE[level]; // 无击退抗性
        }
    }
    ...
    public static class II implements ArmorMaterial {
        ...
        @Override
        public String getName() {
            return "trainees:train_ii"; // 纹理路径: train_ii_layer_1.png
        }
        @Override
        public float getToughness() {
            return TOUGHNESS_VALUE[level]; // 无韧性
    ...
    public static class III implements ArmorMaterial {
        ...
        @Override
        public String getName() {
            return "trainees:train_iii"; // 纹理路径: train_iii_layer_1.png
        }
        @Override
        public float getToughness() {
            return TOUGHNESS_VALUE[level]; // 无韧性
