...
public class ChemicalEquation {
    ...
    private ChemicalEquation(Builder builder) {
        ...
        this.reactants = Collections.unmodifiableList(new ArrayList<>(builder.reactants));
        this.products = Collections.unmodifiableList(new ArrayList<>(builder.products));
        this.conditions = builder.conditions;
        this.catalysts = Collections.unmodifiableList(new ArrayList<>(builder.catalysts));
    ...
    public boolean executeReaction(Level level,
        ...
        if (remaining > 0) {
            ...
            ItemEntity remainderEntity =
                    new ItemEntity(
                            level, entity.getX(), entity.getY(), entity.getZ(),
                            remainderStack
                    );
            remainderEntity.setDeltaMovement(entity.getDeltaMovement());
        ...
        for (ChemicalComponent product : products) {
            ...
            if (!productStack.isEmpty()) {
                ...
                productEntity.setDeltaMovement(entity.getDeltaMovement());
                level.addFreshEntity(productEntity);
            }
        }
