...
public class ReactionConditions {
     ...
     * 在水中
     */
    public static final RCondition IN_WATER =
            (stack, entity) -> entity.isInWater();

    /**
     * 在阳光下
     */
    public static final RCondition IN_SUNLIGHT =
            (stack, entity) -> Tools.isInSunlight(entity);

    /**
     * 下雨/雷暴天气
     */
    public static final RCondition IN_RAIN =
            (stack, entity) -> entity.level().isRaining() || entity.level().isThundering();

    /**
     * 白天
     */
    public static final RCondition IS_DAYTIME =
            (stack, entity) -> entity.level().isDay();

    /**
     * 晚上
     */
    public static final RCondition IS_NIGHT =
            (stack, entity) -> entity.level().isNight();
...
// ==================== 时间条件构建器 ====================
    ...
    public static final Lazy<RCondition> hbpoDecomposeCondition = Lazy.of(
            () -> and(
            isItem(ModChemistry.ModChemistryItems.CHE_HBPO.get()),
            IN_SUNLIGHT,
